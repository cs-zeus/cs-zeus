 ...
 */
export const getVectorDistance = (vector1: Vector, vector2 = getVector()) => getVectorSize(getVector(vector1.x - vector2.x, vector1.y - vector2.y));
 ...
 */
export const addVector = (vector1: Vector, vector2 = getVector()) => getVector(vector1.x + vector2.x, vector1.y + vector2.y);
 ...
 */
export const subtractVector = (vector1: Vector, vector2 = getVector()) => getVector(vector1.x - vector2.x, vector1.y - vector2.y);
